    ...
    <div className='search-container'>
      ...
      <div className='search-form'>
        ...
        <button className='search-button'>
          <img
            src='https://cdn-assets.alltrails.com/assets/packs/73160f92adaa640e4b1e.svg'
            alt='icon'
          ></img>
        </button>
      </div>
          ...
          if (park.park_name.toLowerCase().startsWith(params.toLowerCase())) {
            return (
              <div key={"park" + `${idx}`} className='park-search-container'>
                <li
                  className='park-search-button'
                  onClick={() => handlePath(park.id, "park")}
                >
          ...
          if (trail.trail_name.toLowerCase().startsWith(params.toLowerCase())) {
            return (
              <div key={"trail" + `${idx}`} className='park-search-container'>
                <li
                  className='park-search-button'
                  onClick={() => handlePath(trail.id, "trail")}
                >
                  <div className='park-search-img'>
...
//               park.park_name
//                 .toLowerCase()
//                 .startsWith(this.state.params.toLowerCase())
//             ) {
//               return (
//                 <div key={"park" + `${idx}`} className='park-search-container'>
//                   <li
//                     className='park-search-button'
//                     onClick={() => this.handlePath(park.id, "park")}
//                   >
//                     <div className='park-search-img'>
//                       <img src='https://some-trails-aa-dev.s3.us-west-1.amazonaws.com/buttons/park.png' />
//                     </div>
...
//                   <li
//                     className='park-search-button'
//                     onClick={() => this.handlePath(trail.id, "trail")}
//                   >
//                     <div className='park-search-img'>
//                       <img src='https://some-trails-aa-dev.s3.us-west-1.amazonaws.com/buttons/trails.png' />
//                     </div>
